...
curl -fsSL https://raw.githubusercontent.com/KunoLu/tokens/v1.0.1/pre-install-tokens.sh | bash -s -- https://<线上域名>

# Windows
iex "& { $(irm https://raw.githubusercontent.com/KunoLu/tokens/v1.0.1/pre-install-tokens.ps1) } -Site https://<线上域名>"
```
