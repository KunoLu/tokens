...
export const SOURCE_LOGOS: Record<ClientType, string> = {
  ...
  augment: `${GITHUB_CDN_BASE}/client-augment.png`,
  kimchi: `${GITHUB_CDN_BASE}/client-kimchi.png`,
  "prime-agent": `${GITHUB_CDN_BASE}/client-prime-agent.jpg`,
  cherrystudio: `${GITHUB_CDN_BASE}/client-cherrystudio.png`,
  dsh: `${GITHUB_CDN_BASE}/client-dsh.png`,
  mcode: `${GITHUB_CDN_BASE}/client-mcode.jpg`,
  omp: `${GITHUB_CDN_BASE}/client-omp.jpg`,
