...
export function TokenGraph3D({
  ...
  const statSubtext = "hidden text-xs text-muted-foreground sm:block";
  const statsBox = "flex justify-between rounded-md border border-border bg-card px-1 md:px-2";
