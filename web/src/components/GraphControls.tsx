...
export function GraphControls({
  ...
  return (
    <div className="relative mb-4">
      {/* Heading and controls are one wrapping flex row rather than a pair of
          floats: a float let a long "N tokens used in YYYY" heading run
          underneath the view toggle on a narrow viewport instead of pushing the
          controls onto their own line. */}
